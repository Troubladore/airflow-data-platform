...
class Trade(TemporalTable, table=True):
    ...
    batch_id: str = Field(schema_extra={"temporal_exclude": True})               # 🚫 Not tracked
    large_document: bytes = Field(schema_extra={"temporal_exclude": True})       # 🚫 Not tracked
    computed_cache: str = Field(schema_extra={"temporal_exclude": True})         # 🚫 Not tracked
```
