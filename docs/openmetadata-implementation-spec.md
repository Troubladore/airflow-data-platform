...
### Step 1.2: Configure OpenMetadata via Setup Wizard

Run the platform setup wizard to configure OpenMetadata:
...
The wizard will prompt for OpenMetadata configuration and generate `platform-config.yaml` with settings like:
